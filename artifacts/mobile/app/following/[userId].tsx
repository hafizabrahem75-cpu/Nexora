...
export default function FollowingScreen() {
  ...
  useEffect(() => {
    ...
    apiFetch<{ following: FollowUser[] }>(`/follows/${userId}/following`, { token })
      .then(({ following }) => setUsers(following))
      .catch(() => {})
  ...
  return (
    <View style={[styles.root, { paddingTop: top }]}>
      <View style={styles.topBar}>
        ...
        <Text style={styles.title}>يتابع</Text>
        <View style={{ width: 22 }} />
      </View>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.center}>
              <Text style={styles.empty}>لا يتابع أحداً بعد</Text>
            </View>
          }
        />
      )}
